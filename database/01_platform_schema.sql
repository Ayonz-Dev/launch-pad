...
-- Lane maintainer role: owns shipping-lane maintenance (npm run lanes:add-port /
-- lanes:generate). A dedicated permission + role so it can be assigned to one user.
insert into iam.permissions (application_id, permission_key, description)
